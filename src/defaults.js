...
exports = module.exports = {
   ...
   * @since  		0.0.1
	...
	db: {
	   ...
	   * @type {string}
		 */
		path: function() { return path.join(this.data, this.file); },
	   ...
	   * @type {string}
		 */
		migrations: FsUtils.resolve(`/src/data/migrations/${Config.nodenv == "production" ? "prod" : "dev" }`),
	...
	dist: {
		...
		path: function() { return path.join(this.directory, this.file); }
	},
